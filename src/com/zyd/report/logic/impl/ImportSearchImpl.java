 ...
 * 
 */
public abstract class ImportSearchImpl implements IImportSearchFacade {
	...
	protected StringBuffer search_companycode(Map<String, String> map,
		...
		if (companyCode != null && !(companyCode.isEmpty())) {
			search.append(" and " + companyName + " = '" + companyCode + "'");
		}
		return search;
	}
	...
	/**
	 * 根据结算周期(tbMouth[java.lang.String]:YYMM)查询公共方法
	 * 
	 * @param map
	 * @return
	 */
