...
<html>
	...
	$(function() {
		...
		//添加结算日期的非空验证
		//fulldate("selectbutton", "aceptDatestartmonthfinanceAlready",
		//		"aceptDateendmonthfinanceAlready");
	})
</script>
	...
	<body class="easyui-layout" scroll="no">
		<div region="center">
			<div id="allreportsearch" style="height: 35%; display: block;">
				<form action="financealready.do?method=getFinanceList" method="post"
					id="form" name="">
					<table width="437" border="0" align="center">
						<!-- <tr>
							...
							<td>
								<input type="text" name="financeAlreadymailNum"
									id="financeAlreadymailNum" />
							</td>
						</tr> 
						-->
						<tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="aceptDatestartmonthfinanceAlready"
									onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate"
									readonly="readonly" id="aceptDatestartmonthfinanceAlready"
									value="" />
								-
								<input type="text" name="aceptDateendmonthfinanceAlready"
									onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate"
									readonly="readonly" id="aceptDateendmonthfinanceAlready"
									value="" />
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<select id="tonetCodefinanceAlready"
									name="tonetCodefinanceAlready" style="width:120">
									<option value="">
										请选择
								</select>
							</td>
						...
						<tr>
							<td></td>
							<td>
								<input id="selectbutton" type="submit" value="提 交" />
							</td>
						</tr>
					</table>
				</form>
