		...
		<div region="center">
			<div id="allreportsearch" style="height: 35%; display: block;">
				<table align="center" width="700">
					...
					<c:forEach items="${ListNotFinance}" var="list">
						<tr>
							<td>
								${list[0] }
							</td>
					...
					<c:forEach items="${ListNotFinanceCount}" var="financenot">
						<tr>
							<td colspan="3" align="left">邮件数量：${financenot[0] }</td>
							<td align="left">合计：${financenot[3] }</td>
						</tr>
					</c:forEach>
				</table>
			</div>
