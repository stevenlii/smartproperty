...
<html>
	...
	-->
		...
		<script type="text/javascript">
	$(function() {
		compayCodeselect("1", "tonetCodehandle");
		fulldate("selectbutton","pa95startmonthfinanceAlready","pa95endmonthfinanceAlready");
	})
</script>
	...
	<body class="easyui-layout" scroll="no">
		<div region="center">
			<div id="allreportsearch" style="height: 35%; display: block;">
				<form action="financealready.do?method=getFinanceHandle"
					...
					<table width="437" border="0" align="center">
						<tr>
							...
							<td>
								<select id="tonetCodehandle"
									name="tonetCodehandle" style="width: 160">
									<option value="">
										请选择
								</select>
							</td>
						...
						<tr>
							<td></td>
							<td>
								<input id="handlebutton" type="submit" value="提 交" />
							</td>
						</tr>
					</table>
				</form>
