		...
		<div id="allreportsearch" style="height: 20%;display:none;">
			<form action="" method="post" id="form" name="">
				<table width="513" border="0" align="center">
					...
					<tr>
						<td><span style="float:right ">收件人姓名:</span>
						</td>
						<td><input type="text" name="recipienName" id="recipienName"
							style="width: 150px;" /></td>
					</tr>
					<tr>
						<td><span style="float:right ">收寄局机构:</span>
						</td>
						<td><input type="text" name="aceptSetupe" id="aceptSetupe"
							style="width: 150px;" /></td>
					</tr>
					<tr>
						<td><span style="float:right ">投递局:</span>
						</td>
						<td><input type="text" name="mailingSetupe"
							id="mailingSetupe" style="width: 150px;" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td><span style="float:right ">大客户代码:</span>
						</td>
						<td><input type="text" name="customerCode" id="customerCode"
							style="width: 150px;" /></td>
					</tr>
					<tr>
						<td><span style="float:right ">应收货款:</span>
						</td>
						<td><input type="text" name="payFee" id="payFee"
							style="width: 150px;" /></td>
					</tr>
					<tr>
						<td><span style="float:right ">结算邮件类型标识:</span>
						</td>
						<td><input type="text" name="billMailTypes"
							id="billMailTypes" style="width: 150px;" /></td>
					</tr>
					<tr>
						<td></td>
