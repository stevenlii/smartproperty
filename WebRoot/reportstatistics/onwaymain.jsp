...
<script type="text/javascript">
	...
	function woquexport(){
		...
		if (isexportfile == "" || isexportfile == null){
			...
			window.open("onWay.do?method=downfile");
			return true;
		}
	}
	function exportexcel(){
		...
		if (isexportfile == "" || isexportfile == null){
			...
			window.open("onWay.do?method=downEXCEL");
			return true;
		}
	}
</script>
...
<body class="easyui-layout">
	...
	<div id="mainPanle" region="center" style="overflow: auto;"
		...
		<!--速递局人员查询页面-->
		<form action="onWay.do?method=getStatistics" method="post" id="form"
			name="form">
		...
		<div>
			...
			<table width="700" border="0" align="center">
				<tr>
					<td width="101" align="center">交寄日期</td>
					<td width="100" align="center">邮件号</td>
					<td width="131" align="center">应收货款</td>
					<td width="120" align="center">入网公司</td>
					<td width="120" align="center">寄达地</td>
				</tr>
